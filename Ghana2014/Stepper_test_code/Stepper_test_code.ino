...
//  int SPEED = 30000;
  ...
  Backward(TIME,SPEED);
  //Forward(20000,30000);
  //Backward(50000,30000);
} 

void Forward(int time, int rotspeed){
  L6470_run(0,rotspeed);
  delay(time);
  L6470_softstop();
  L6470_busydelay(500);
}

void Backward(int time, int rotspeed){
  L6470_run(1,rotspeed);
  delay(time);
  L6470_softstop();
  L6470_busydelay(500);    
}
...
L6470_setparam_maxspeed(0x041); //default 0x041 (10bit) (15.25*val+15.25[step/s])
...
L6470_setparam_kvalrun(0x29); //default 0x29 (8bit) (Vs[V]*val/256)
L6470_setparam_kvalacc(0x29); //default 0x29 (8bit) (Vs[V]*val/256)
L6470_setparam_kvaldec(0x29); //default 0x29 (8bit) (Vs[V]*val/256)
