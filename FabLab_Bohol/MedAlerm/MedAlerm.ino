...
void setup()
{
  Serial.begin(9600);
  tone1.begin(13);
  setTime(20,45,0,1,23,14); // set time to Saturday 8:29:00am Jan 1 2011
  Alarm.alarmRepeat(7,0,0, Buzz);  // 8:30am every day
//  Alarm.alarmRepeat(17,45,0,EveningAlarm);  // 5:45pm every day 
//  Alarm.alarmRepeat(dowSaturday,8,30,30,WeeklyAlarm);  // 8:30:30 every Saturday 
//  Alarm.timerRepeat(15, Repeats);            // timer for every 15 seconds    
  Alarm.timerOnce(10, Buzz);             // called once after 10 seconds 
}
